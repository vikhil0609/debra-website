              ...
              <div className="single-testimoinal-item">
                <div className="client-info">
                  <img
                    ...
                    src="https://www.leadsquared.com/wp-content/uploads/2022/02/gartner.png"
                  />
                ...
                <div className="feedback">
                  “Sales funnels managed effectivey, thanks to LeadSquared”
                </div>
              </div>
              <div className="single-testimoinal-item">
                <div className="client-info">
                ...
                <div className="horizontal-line"></div>
                <div className="feedback">
                  “Excellent app for coin technology and it built on top of
                  potential work. And there are programming assignments record.”
                </div>
              </div>
              <div className="single-testimoinal-item">
                <div className="client-info">
                ...
                <div className="feedback">
                  ...
                  outstanding job you did for us. The app is just what we
                  wanted.”
                </div>
              </div>
              <div className="single-testimoinal-item">
